            ...
            if player_num == self.dealer:
                ...
                while True:
                    ...
                    if trump_suit in ["H", "D", "C", "S"] and trump_suit != self.kittyCard[0]:
                        ...
                        log_bidding_decision(player_num, hand, self.kittyCard, self.dealer, 2, self.kittyCard, trump_suit)
                ...
                if choice == "choose":
                    ...
                    print(f"{name} passed.\n")
                    log_bidding_decision(player_num, hand, self.kittyCard, self.dealer, 2, self.kittyCard, 5)
